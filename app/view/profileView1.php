						...
						<div id = "basic" class = "info-details info-basic-wrapper inactive">
							...
							<div id = "info-basic-user-name-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("uname",3)'/>
									</div>
								</form>
							</div>
							...
							<div id = "info-basic-email-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("mail",4)' />
									</div>
								</form>
							</div>
							...
							<div id = "info-basic-phn-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("phn",5)'/>
									</div>
								</form>
							</div>
							...
							<div id = "info-basic-addrss-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("addrss",6)'/>
									</div>
								</form>
							</div>
						...
						<div id = "edu" class = "info-details info-edu-wrapper inactive">
							...
							<div id = "info-basic-schl-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("schl",7)'/>
									</div>
								</form>
							</div>
							...
							<div id = "info-basic-clg-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("clg",8)'/>
									</div>
								</form>
							</div>
							...
							<div id = "info-basic-uni-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("uni",9)'/>
									</div>
								</form>
							</div>
							...
							<div id = "info-basic-wrkplc-edit" class = "row info-overview">
								...
								<form>
									...
									<div class = "info-basic-button-wrapper col-l-6">
										<input type = "button" value = "save" class = "info-basic-submit-button" onclick = 'saveField("wrkplc",10)'/>
									</div>
								</form>
							</div>
